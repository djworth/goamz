...
func (s *S) TestCreateQueue(c *C) {
	...
	c.Assert(q.Url, Equals, "http://localhost:4444/123456789012/testQueue")
	c.Assert(err, IsNil)
}
...
func (s *S) TestListQueues(c *C) {
	...
	c.Assert(resp.QueueUrl[0], Equals, "http://localhost:4444/123456789012/testQueue")
	c.Assert(resp.ResponseMetadata.RequestId, Equals, "725275ae-0b9b-4762-b238-436d7c65a1ac")
	c.Assert(err, IsNil)
}

func (s *S) TestGetQueueUrl(c *C) {
	testServer.Response(200, nil, TestGetQueueUrlXmlOK)
	...
	c.Assert(req.URL.Path, Equals, "/")
	c.Assert(req.Header["Date"], Not(Equals), "")
	c.Assert(resp.QueueUrl, Equals, "http://localhost:4444/123456789012/testQueue")
...
func (s *S) TestChangeMessageVisibilityBatch(c *C) {
	...
	testServer.Response(200, nil, TestChangeMessaveVisibilityBatchXmlOK)
...
func (s *S) TestDeleteMessage(c *C) {
	...
	testServer.Response(200, nil, TestDeleteMessageXmlOK)
...
func (s *S) TestDeleteMessageBatch(c *C) {
	...
	testServer.Response(200, nil, TestDeleteMessageBatchXmlOK)
...
func (s *S) TestSendMessageBatch(c *C) {
	...
	testServer.Response(200, nil, TestSendMessageBatchXmlOK)
...
func (s *S) TestGetQueueAttributes(c *C) {
	...
	testServer.Response(200, nil, TestGetQueueAttributesAllXmlOK)
...
func (s *S) TestGetQueueAttributesSelective(c *C) {
	...
	testServer.Response(200, nil, TestGetQueueAttributesSelectiveXmlOK)
...
func (s *S) TestSetQueueAttributes(c *C) {
	...
	testServer.Response(200, nil, TestSetQueueAttributesXmlOK)
	var policyStr = `
  {
        "Version":"2008-10-17",
